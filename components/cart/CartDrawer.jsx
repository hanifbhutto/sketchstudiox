...
export default function CartDrawer() {
  ...
  const handleDeleteItem = async (itemId) => {
    ...
    try {
      // Small artificial delay for smooth loader feedback
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-stone-100">
                            ...
                            <button
                              ...
                              className="text-[#867E74] hover:text-rose-600 transition-colors p-1 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center min-w-[28px] min-h-[28px]"
                              title="Remove item"
                            >
                              {isDeleting ? (
